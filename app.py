...
def home():
    ...
    return render_template("home.html", items=items_list, form=form, params=params, items_data=items_data, zip=zip)
...
def get_form_class(item_type):
    item_class_name = item_type.capitalize()  # TODO: This may need to be adjusted for CamelCase
...
def items(item_type):
    ...
    return render_template("items.html", form=form, items=items_list, items_data=items_data, zip=zip)
