...
class Scope(db.Model):
    ...
    github_project_id = db.Column(db.BigInteger, nullable=True)
    github_project_name = db.Column(db.String(255), nullable=True)
    github_project_column_id = db.Column(db.BigInteger, nullable=True)
    github_project_column_name = db.Column(db.String(255), nullable=True)
    github_milestone_number = db.Column(db.Integer, nullable=True)
    github_milestone_title = db.Column(db.String(255), nullable=True)
